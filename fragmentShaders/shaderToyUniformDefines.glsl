/*
 *
 * THIS EXAMPLE IMPLEMENTS SHADERTOY SHADER UNIFORMS DEFINED FROM BMAP UNIFORMS
 * You can run code from shaderToy.com in bMap Shader !!!!!!!!
 * Original shader from: https://www.shadertoy.com/view/lt2fDz
 * 
 */
#ifdef GL_ES
...
/*  -----             ------  */
// shadertoy.com uniforms refdefinition
/*  -----             ------  */
// shadertoy emulation
#define iTime time
...
{
	vec3 col = vec3(255.);
    col.x = 56100000. * pow(Temp,(-3. / 2.)) + 140.;
